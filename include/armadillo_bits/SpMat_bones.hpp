...
class SpMat : public SpBase< eT, SpMat<eT> >
  ...
  template<typename T1> inline explicit SpMat(const Op<T1, op_sp_plus>& expr);
  template<typename T1> inline explicit SpMat(const Op<T1, op_sp_minus_pre>& expr);
  template<typename T1> inline explicit SpMat(const Op<T1, op_sp_minus_post>& expr);
