...
// is_spop          = boolean indicating whether the Q object has a unary sparse matrix operation
// 
...
struct Proxy< eOp<T1, eop_type> >
  ...
  static constexpr bool is_spop = eOp<T1, eop_type>::is_spop;
...
struct Proxy< eGlue<T1, T2, eglue_type> >
  ...
  static constexpr bool is_spop = eGlue<T1, T2, eglue_type>::is_spop;
...
struct Proxy< Op<T1, op_type> >
  ...
  static constexpr bool is_spop = Op<T1, op_type>::is_spop;
...
struct Proxy_xtrans_vector< Op<T1, op_htrans> >
  ...
  static constexpr bool is_spop = Op<T1, op_htrans>::is_spop;
...
struct Proxy_xtrans_vector< Op<T1, op_strans> >
  ...
  static constexpr bool is_spop = Op<T1, op_strans>::is_spop;
...
struct Proxy< Op<T1, op_htrans> >
  ...
  static constexpr bool is_spop = Proxy_xtrans::is_spop;
...
struct Proxy< Op<T1, op_htrans2> >
  ...
  static constexpr bool is_spop = eOp< Op<T1, op_htrans>, eop_scalar_times>::is_spop;
