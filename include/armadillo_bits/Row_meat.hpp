...
Row<eT>::Row(const SizeMat& s, const fill::fill_class<fill_type>& f)
  ...
  inline
  Row<eT>::Row(const uword in_n_elem, const fill::fill_class_cxx11<fill_type>& f, URNG& g)
    : Mat<eT>(arma_vec_indicator(), 1, in_n_elem, 2)
    {
    arma_extra_debug_sigprint();
  ...
  template<typename fill_type, typename URNG>
  inline
  Row<eT>::Row(const uword in_n_rows, const uword in_n_cols, const fill::fill_class_cxx11<fill_type>& f, URNG& g)
    : Mat<eT>(arma_vec_indicator(), 0, 0, 2)
    {
    arma_extra_debug_sigprint();
  ...
  template<typename fill_type, typename URNG>
  inline
  Row<eT>::Row(const SizeMat& s, const fill::fill_class_cxx11<fill_type>& f, URNG& g)
    : Mat<eT>(arma_vec_indicator(), 0, 0, 2)
    {
    arma_extra_debug_sigprint();
...
Row<eT>::fixed<fixed_n_elem>::fixed(const fill::fill_class<fill_type>&)
  ...
  template<typename fill_type, typename URNG>
  inline
  Row<eT>::fixed<fixed_n_elem>::fixed(const fill::fill_class_cxx11<fill_type>& f, URNG& g)
    : Row<eT>( arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local) )
    {
    arma_extra_debug_sigprint_this(this);
